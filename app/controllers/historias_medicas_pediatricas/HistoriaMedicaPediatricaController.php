	...
	public function nueva_historia_medica_pediatrica($id_paciente_pediatrico)
		{
			...
			#dd(ExamenFuncionalPediatrico::existeExamen($id_paciente_pediatrico));
	...
	public function crear_historia_medica_pediatrica()	
		{
			...
			if($respuesta['error_mensajes'] == true)
				...
				{
					return Redirect::to('pacientes_pediatricos/creacion_historia_medica_pediatrica/'.Session::get('id_paciente_pediatrico'))->with(['mensaje'=>$respuesta['mensaje'],'estilo'=>$respuesta['estilo'] ]);
