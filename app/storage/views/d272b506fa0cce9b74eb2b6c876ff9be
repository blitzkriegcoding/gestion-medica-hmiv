<h3>
	Módulo de ingreso de paciente pediátrico existente
</h3>
<br><br>

<div class="wizard" data-initialize="wizard" id="myWizard">
				<ul class="steps">
					<li data-step="1" class="active"><span class="badge">1</span>Datos de ingreso<span class="chevron"></span></li>
				...
				<div class="step-content">
					...
					<div class="step-pane sample-pane alert-success alert" data-step="5">
						<h4>Send Message</h4>
